  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      toast({
        ...
        description: "You'll receive updates about our latest IT solutions and insights."
      });
      setEmail("");
  ...
  return <section id="newsletter" className="bg-white py-0">
      <div className="section-container opacity-0 animate-on-scroll">
        <div className="max-w-6xl mx-auto">
          ...
          <h2 className="text-5xl font-display font-bold mb-4 text-left">Stay Updated with Technology Trends</h2>
          <p className="text-xl text-gray-700 mb-10 text-left">
            Get the latest insights on web development, mobile apps, and emerging tech solutions
          </p>
